<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bzzx.aspx.cs" Inherits="Winsoft.Web.bzzx" %>
        ...
        <div class="dfr_con">
        	<ul>
            	<asp:Repeater ID="rtManage" runat="server">
                    <ItemTemplate>
                <li><b>·</b><a href="bzzx_xx.aspx?id=<%#Eval("N_ID") %>" title='<%#Eval("N_Title")%>'><%#Eval("N_Title")%></a></li>    
                    </ItemTemplate>
                </asp:Repeater>
            </ul>
        </div>
