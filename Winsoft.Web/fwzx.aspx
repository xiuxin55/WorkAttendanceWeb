<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fwzx.aspx.cs" Inherits="Winsoft.Web.fwzx" %>
...
<div class="dlp_ttl">
    	<a href="index.aspx">首页</a>&nbsp;>&nbsp;<a href="fwzx.aspx">服务中心</a>
</div>
<div class="dlp_main">
	<div class="dlm_fwzx_left">
        ...
        <ul>
        	<asp:Repeater ID="rtMenu" runat="server">
                <ItemTemplate>
            <li><a href="fwzx.aspx?id=<%#Eval("N_ID") %>" title='<%#Eval("N_Str1")%>'><%#Eval("N_Str1")%></a> &gt;</li>     
                </ItemTemplate>
            </asp:Repeater>
        </ul>
    </div>
