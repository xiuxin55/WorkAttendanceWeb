<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bzxx.aspx.cs" Inherits="Winsoft.Web.admin.main.scxw.bzxx" %>
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="N_Str1" runat="server" CssClass="page02_1">
                                </asp:DropDownList>
                            </td>
                            <td style="padding-left:5px;">文章标题：</td>
                            <td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="25%" class="table04_1">菜单标题</th>
            <th nowrap="nowrap" width="25%" class="table04_1">文章标题</th>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <td nowrap="nowrap" class="table04_l"><span><%#GetStr1(Eval("N_Str1").ToString())%></span></td>
