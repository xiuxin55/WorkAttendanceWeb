<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bzxx_tjxg.aspx.cs" Inherits="Winsoft.Web.admin.main.scxw.bzxx_tjxg" ValidateRequest="false" %>
...
<body style="background:#F5F9FC;">
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="1" class="table05">
            ...
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">文章标题：</td>
