...
namespace Winsoft.Web.admin.main.scxw
{
    public partial class bzxx : System.Web.UI.Page
    {
        ...
        private void BindType()
        {
            ...
            //}
            //this.N_Str1.Items.Insert(0, new ListItem("全部", "0"));
        }
        ...
        /// <returns></returns>
        protected string GetStr1(string N_ID)
        {
            //NewsInfo model = NewsInfoManage.GetInstance().GetModel(N_ID);
            //if (model != null)
            //{
            //    return model.N_Str1;
            //}
