<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="spxstj.aspx.cs" Inherits="Winsoft.Web.admin.main.scsp.spxstj" %>
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="35%" class="table04_1">会员帐号</th>
            <th nowrap="nowrap" width="30%" class="table04_1">购买价格</th>
            <th nowrap="nowrap" width="30%" class="table04_1">购买数量</th>
          </tr>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <td nowrap="nowrap" class="table04_r"><span><%#Eval("V_Count")%></span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
          <%
