<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="spxx.aspx.cs" Inherits="Winsoft.Web.admin.main.scsp.spxx" %>
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="10%" class="table04_1">视频类型</th>
            <th nowrap="nowrap" width="32%" class="table04_1">视频名称</th>
            <th nowrap="nowrap" width="10%" class="table04_1">视频价格</th>
            <th nowrap="nowrap" width="10%" class="table04_1">课时数</th>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            <td nowrap="nowrap" class="table04_c"><span><input class="tab_p" type="checkbox" name="Item" value="<%# Eval("V_ID") %>" /></span></td>
            ...
            <td nowrap="nowrap" class="table04_r"><span>￥<%#Eval("V_NewPrice")%></span></td>
            <td nowrap="nowrap" class="table04_r"><span><%#Eval("V_LessonCount")%></span></td>
            ...
            <a href='ksxx.aspx?code=<%=Request["code"] %>&vid=<%#Eval("V_ID") %>'>课时信息</a>
            <a href='<%# M_EUrl +"&id="+ Eval("V_ID") %>'>编辑</a>
            <asp:LinkButton ID="btnDelete" runat="server" Text="删除" CommandName="delete" CommandArgument='<%#Eval("V_ID") %>' />
            </span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
