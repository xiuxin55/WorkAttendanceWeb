<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ygmkc.aspx.cs" Inherits="Winsoft.Web.admin.main.scsp.ygmkc" %>
...
<body style="background:#F5F9FC;">
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-left:5px;">付款时间：</td>
                            <td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="15%" class="table04_1">付款时间</th>
          </tr>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <td nowrap="nowrap" class="table04_c"><span><%#Convert.ToDateTime(Eval("O_PaymentTime")).ToString("yyyy-MM-dd HH:mm:ss")%></span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
          <%
