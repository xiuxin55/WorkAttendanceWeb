<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ksxx.aspx.cs" Inherits="Winsoft.Web.admin.main.scsp.ksxx" %>
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
   			    ...
   			    <tr style="color:#135294;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="tab_c"><asp:Button ID="btnAdd" runat="server" Text="新 增" CssClass="page02_4" onclick="btnAdd_Click" /></td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="30%" class="table04_1">课时名称</th>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            <td nowrap="nowrap" class="table04_c"><span><input class="tab_p" type="checkbox" name="Item" value="<%# Eval("VL_ID") %>" /></span></td>
            ...
            <td nowrap="nowrap" class="table04_c"><span><%#Convert.ToDateTime(Eval("VL_Time")).ToString("yyyy-MM-dd HH:mm:ss")%></span></td>
            <td nowrap="nowrap" class="table04_c" valign="middle"><span class="tab">
            <a href='ksxx_tjxg.aspx?code=<%=Request["code"] %>&vid=<%=Request["vid"] %>&id=<%#Eval("VL_ID")%>'>编辑</a>
