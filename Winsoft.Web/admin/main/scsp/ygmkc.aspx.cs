...
{
    public partial class ygmkc : System.Web.UI.Page
    {
        ...
        private void Bind()
        {
            ...
            string strWhere = " and p1.O_Status='已付款'";//查询条件
            ...
            {
                strWhere += " and p1.O_PaymentTime between '" + start + " 00:00:00' and '" + end + " 23:59:59'";
            }
