...
<body style="background:#F5F9FC;">
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-left:5px;">评论时间：</td>
                            <td>
                            ...
                            <td style="padding-left:5px;">回复时间：</td>
                            <td>
                            ...
                            <td style="padding-left:5px;">回复帐号：</td>
                            <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td style="padding-left:5px;">评价状态：</td>
                            <td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="10%" class="table04_1">会员帐号</th>
            <th nowrap="nowrap" width="10%" class="table04_1">回复帐号</th>
            <th nowrap="nowrap" width="15%" class="table04_1">视频名称</th>
            <th nowrap="nowrap" width="10%" class="table04_1">评价状态</th>
            <th nowrap="nowrap" width="14%" class="table04_1">评论时间</th>
            <th nowrap="nowrap" width="14%" class="table04_1">回复时间</th>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <td nowrap="nowrap" class="table04_c" valign="middle"><span class="tab">
                ...
                <a href='<%# M_EUrl +"&id="+ Eval("C_ID") %>'>查看</a>
                <asp:LinkButton ID="btnTg" runat="server" Text="通过" CommandName="tg" CommandArgument='<%#Eval("C_ID") %>' />
                <asp:LinkButton ID="btnCh" runat="server" Text="撤回" CommandName="ch" CommandArgument='<%#Eval("C_ID") %>' />
                <asp:LinkButton ID="btnHf" runat="server" Text="回复" CommandName="hf" CommandArgument='<%#Eval("C_ID") %>' />
                <asp:LinkButton ID="btnDelete" runat="server" Text="删除" CommandName="delete" CommandArgument='<%#Eval("C_ID") %>' />
            </span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
          ...
          %>
          <tr>
            <td nowrap="nowrap" colspan="9"><span>暂时没有找到相关的数据</span></td>
          </tr>
          <%        
              }
               %>
