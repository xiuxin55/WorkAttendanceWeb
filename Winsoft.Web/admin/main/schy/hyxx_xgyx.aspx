<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hyxx_xgyx.aspx.cs" Inherits="Winsoft.Web.admin.main.schy.hyxx_xgyx" %>
    ...
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="1" class="table05">
            ...
            <tr>
                ...
                <td nowrap="nowrap" class="tab_td_edit_l"><input id="M_EMail" runat="server" type="text" class="page03_1"/></td>
            </tr>
        </table>
    </form>
</body>
