<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hyxx.aspx.cs" Inherits="Winsoft.Web.admin.main.schy.hyxx" EnableEventValidation="false" %>
...
<body style="background:#F5F9FC;">
    ...
    <table cellpadding="0" cellspacing="1" class="table04">
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <a href='<%# M_EUrl +"&id="+ Eval("M_ID") %>'>编辑</a>
            <a href='hyxx_xgmm.aspx?code=<%=Request["code"] %>&id=<%#Eval("M_ID")%>'>修改密码</a>
            <a href='hyxx_xgyx.aspx?code=<%=Request["code"] %>&id=<%#Eval("M_ID")%>'>修改邮箱</a>
            </span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
