<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lljl.aspx.cs" Inherits="Winsoft.Web.admin.main.schy.lljl" %>
...
<body style="background:#F5F9FC;">
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-left:5px;">浏览时间：</td>
                            <td>
                            ...
                            <td style="padding-left:5px;">IP地址：</td>
                            <td>
                                <input name="" type="text" runat="server" class="page02_2" id="VH_IP" />
                            </td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="25%" class="table04_1">IP地址</th>
            <th nowrap="nowrap" width="30%" class="table04_1">视频名称</th>
            <th nowrap="nowrap" width="15%" class="table04_1">浏览时间</th>
            <th nowrap="nowrap" width="15%" class="table04_1">基本操作</th>
          </tr>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            <td nowrap="nowrap" class="table04_c"><span><input class="tab_p" type="checkbox" name="Item" value="<%# Eval("VH_ID") %>" /></span></td>
            ...
            <td nowrap="nowrap" class="table04_l"><span><%#Eval("VH_IP")%></span></td>
            <td nowrap="nowrap" class="table04_l"><span><%#Eval("V_Name")%></span></td>
            <td nowrap="nowrap" class="table04_c"><span><%#Convert.ToDateTime(Eval("VH_Time")).ToString("yyyy-MM-dd HH:mm:ss")%></span></td>
            <td nowrap="nowrap" class="table04_c" valign="middle"><span class="tab">
            <asp:LinkButton ID="btnDelete" runat="server" Text="删除" CommandName="delete" CommandArgument='<%#Eval("VH_ID") %>' />
            </span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
