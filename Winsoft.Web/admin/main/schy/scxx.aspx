<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="scxx.aspx.cs" Inherits="Winsoft.Web.admin.main.schy.scxx" %>
...
<body style="background:#F5F9FC;">
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-left:5px;">收藏时间：</td>
                            <td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="25%" class="table04_1">会员帐号</th>
            <th nowrap="nowrap" width="30%" class="table04_1">视频名称</th>
            <th nowrap="nowrap" width="15%" class="table04_1">收藏时间</th>
