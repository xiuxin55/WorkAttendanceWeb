<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pjxx_tjxg.aspx.cs" Inherits="Winsoft.Web.admin.main.schy.pjxx_tjxg" %>
...
<body style="background:#F5F9FC;">
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="1" class="table05">
            ...
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">回复帐号：</td>
                <td nowrap="nowrap" class="tab_td_edit_l" colspan="2"><asp:Label ID="A_Username" runat="server" Text=""></asp:Label></td>
            </tr>
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">回复时间：</td>
                <td nowrap="nowrap" class="tab_td_edit_l" colspan="2"><asp:Label ID="C_ReplyTime" runat="server" Text=""></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td nowrap="nowrap" class="tab_td_edit_t" colspan="3">
                	<textarea runat="server"  id="C_ReplyContent" name="content" style="width:99%;height:100px; border:1px solid #ccc;" readonly="readonly"></textarea>
                </td>
            </tr>
        </table>
    </form>
