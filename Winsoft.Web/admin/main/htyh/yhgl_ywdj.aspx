<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yhgl_ywdj.aspx.cs" Inherits="Winsoft.Web.admin.main.htyh.yhgl_ywdj" EnableEventValidation="false" %>
...
<body style="background:#F5F9FC;">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        onclick="btnCommit_Click" /></td>
                           <td class="tab_c"><asp:Button ID="Print" runat="server" Text="导 出" CssClass="page02_4" 
    ...
    <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <%  if (IsVisible)
              { %>
             <th nowrap="nowrap" width="10%" class="table04_1">作废操作</th>
             <%} %>
          </tr>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)" ondblclick="DJ_Click('<%# Eval("Prize_Guid") %>')">
            ...
            <input id="btn_DJ" type="button" value="作废记录" onclick="DeleteData('<%# Eval("Prize_Guid") %>');"  />
