...
<body style="background:#F5F9FC;">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td style="padding-left:5px;">用户帐号：</td>
                            <td>
    ...
    <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="15%" class="table04_1">用 户 名</th>
            <th nowrap="nowrap" width="15%" class="table04_1">所属网点</th>
            <th nowrap="nowrap" width="15%" class="table04_1">电子邮箱</th>
            <th nowrap="nowrap" width="20%" class="table04_1">真实姓名</th>
            <th nowrap="nowrap" width="10%" class="table04_1">联系电话</th>
            <th nowrap="nowrap" width="15%" class="table04_1">注册时间</th>
            <th nowrap="nowrap" width="10%" class="table04_1">编辑操作</th>
            <th nowrap="nowrap" width="10%" class="table04_1">删除操作</th>
          </tr>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <a href='hyxx_tjxg.aspx?id=<%# Eval("US_UserID") %>'>编辑</a>
            ...
            <a href='hyxx_xgyx.aspx?code=<%=Request["code"] %>&id=<%#Eval("US_UserID")%>'>修改邮箱</a>--%>
             ...
             <td nowrap="nowrap" class="table04_c" valign="middle"><span class="tab">
            <a href='#' onclick='DeleteUserData(<%# Eval("US_UserID") %>)'>删除</a>
            </span></td>
          </tr>
            </ItemTemplate>
          </asp:Repeater>
