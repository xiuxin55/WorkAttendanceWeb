<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hyxx_tjxg.aspx.cs" Inherits="Winsoft.Web.admin.main.htyh.hyxx_tjxg" %>
        ...
        <table cellpadding="0" cellspacing="1" class="table05">
            ...
            <tr>
              ...
              <td nowrap="nowrap" class="tab_td_edit_r" width="1%">用户帐号：</td>
                <td nowrap="nowrap" class="tab_td_edit_l"><input    id="US_UserName" runat="server" type="text" class="page03_2"/></td>
                
                <td nowrap="nowrap" class="tab_td_edit_r" width="1%">电子邮箱：</td>
                <td nowrap="nowrap" class="tab_td_edit_l"><input id="US_Email" runat="server" type="text" class="page03_2"/></td>
                
            </tr>
            
           
           <tr>
                <td nowrap="nowrap" class="tab_td_edit_r" width="1%">用户密码：</td>
                <td nowrap="nowrap" class="tab_td_edit_l">
                    <input  id="US_Password" runat="server" type="text" class="page03_2" /></td>
            ...
            <tr>
                ...
                <td nowrap="nowrap" class="tab_td_edit_l"><input id="US_Name" runat="server" type="text" class="page03_2"/></td>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">联系电话：</td>
                <td nowrap="nowrap" class="tab_td_edit_l" ><input id="US_TelPhone" runat="server" type="text" class="page03_2"/></td>
            </tr>
        
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">身份证号：</td>
                 <td nowrap="nowrap" class="tab_td_edit_l">
                <asp:TextBox ID="US_CardId" runat="server" CssClass="page03_2"  >
                </asp:TextBox>
               </td>
            ...
            <tr>
                ...
                <td nowrap="nowrap" class="tab_td_edit_l" >
                    <asp:DropDownList Width ="200" ID="WebsiteDropDownList" runat="server" CssClass="page02_1">
                    </asp:DropDownList>
                 </td>
            <%--	<td  nowrap="nowrap" class="tab_td_edit_r" width="1%">用户权限：</td>
                <td nowrap="nowrap" class="tab_td_edit_l" >
                    <asp:DropDownList ID="US_Authentication" runat="server" CssClass="page02_1">
