<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lcgl_spxx.aspx.cs" Inherits="Winsoft.Web.admin.main.scsy.lcgl_spxx" %>
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td style="padding-left:5px;">图片尺寸：</td>
                            <td>
                                <asp:DropDownList ID="N_Type" runat="server" CssClass="page02_1">
                                    <asp:ListItem Value="0">全部</asp:ListItem>
                                    <asp:ListItem Value="1">495 x 190</asp:ListItem>
                                    <asp:ListItem Value="2">245 x 190</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="padding-left:5px;">视频名称：</td>
                            <td>
                                <input name="" type="text" runat="server" class="page02_2" id="N_Title" />
                            </td>
                        </tr>
                    </table>
                    </td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="15%" class="table04_1">图片尺寸</th>
            <th nowrap="nowrap" width="25%" class="table04_1">视频名称</th>
            <th nowrap="nowrap" width="25%" class="table04_1">链接地址</th>
          ...
          <tr onmouseover="changeto(this)" onmouseout="changeback(this)">
            ...
            <td nowrap="nowrap" class="table04_c">
                <span>
                    <%#Eval("N_Type").ToString() == "1" ? " 495 x 190 " : ""%>
                    <%#Eval("N_Type").ToString() == "2" ? " 245 x 190 " : ""%>
                </span>
            </td>
            <td nowrap="nowrap" class="table04_l"><span><%#Eval("N_Title")%></span></td>
            <td nowrap="nowrap" class="table04_l"><span><%#Eval("N_Url")%></span></td>
        ...
        PrevPageText="上一页" onpagechanged="AspNetPager1_PageChanged"> </webdiyer:AspNetPager></span>
            ...
            <tr>
            	<td  colspan="7" align="left" style="line-height:25px;">
                    <span style="color:#F00">注意：</span>前台展示时，图片大小为495 x 190，只取前1条数据；图片大小为245 x 190，只取前5条数据。
                </td>
            </tr>
        </table>
        <br />
