<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rkgl_tpgg_tjxg.aspx.cs" Inherits="Winsoft.Web.admin.main.scsy.rkgl_tpgg_tjxg" %>
...
<body style="background:#F5F9FC;">
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="1" class="table05">
            ...
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">广告名称：</td>
            ...
            <tr>
                ...
                <td nowrap="nowrap" class="tab_td_edit_l" ><span style="color:Red;">图片宽度：1345像素，图片高度：415像素。</span></td>
            </tr>
            <tr>
                <td nowrap="nowrap" class="tab_td_edit_t" colspan="2"><asp:Image ID="N_Img" runat="server" ImageUrl="~/images/banner01.jpg"  width="770" height="200"/></td>
            </tr>
        </table>
    </form>
</body>
