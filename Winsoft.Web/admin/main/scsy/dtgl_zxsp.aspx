<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dtgl_zxsp.aspx.cs" Inherits="Winsoft.Web.admin.main.scsy.dtgl_zxsp" %>
        ...
        PrevPageText="上一页" onpagechanged="AspNetPager1_PageChanged"> </webdiyer:AspNetPager></span>
            ...
            <tr>
            	<td  colspan="6" align="left" style="line-height:25px;">
                    <span style="color:#F00">注意：</span>前台展示时，只取前20条数据。
                </td>
            </tr>
        </table>
        <br />
