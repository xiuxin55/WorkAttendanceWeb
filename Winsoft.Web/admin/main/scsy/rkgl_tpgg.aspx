<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rkgl_tpgg.aspx.cs" Inherits="Winsoft.Web.admin.main.scsy.rkgl_tpgg" %>
    ...
    <table cellpadding="0" cellspacing="1" class="table03">
                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td style="padding-left:5px;">广告名称：</td>
                            <td>
        ...
        <table cellpadding="0" cellspacing="1" class="table04">
          <tr>
            ...
            <th nowrap="nowrap" width="25%" class="table04_1">广告名称</th>
        ...
        PrevPageText="上一页" onpagechanged="AspNetPager1_PageChanged"> </webdiyer:AspNetPager></span>
            ...
            <tr>
            	<td  colspan="6" align="left" style="line-height:25px;">
                    <span style="color:#F00">注意：</span>前台展示时，只取前4条数据。
                </td>
            </tr>
        </table>
        <br />
