...
{
    public partial class lcgl_spxx_tjxg : System.Web.UI.Page
    {
        ...
        private void Bind()
        {
            ...
            if (id != null && id != string.Empty)
            {
                ...
                if (model != null)
                {
                    this.N_Type.Text = model.N_Type.ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (N_Type == "0")
            {
                MessageBox.Show(this, "请选择图片尺寸！");
            }
            else if (N_Order == string.Empty)
            {
            ...
            else if (N_Content == string.Empty)
            {
                MessageBox.Show(this, "请输入视频摘要！");
            }
            ...
            else
            {
                ...
                if (b)
                {
                    ...
                    model.N_Type = Convert.ToInt32(N_Type);
                    model.N_Source = "";
                    model.N_Str1 = "";
                    model.N_Str2 = "";
                    model.N_Str3 = "";
