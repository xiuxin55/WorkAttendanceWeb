<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lcgl_spxx_tjxg.aspx.cs" Inherits="Winsoft.Web.admin.main.scsy.lcgl_spxx_tjxg" %>
...
<body style="background:#F5F9FC;">
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="1" class="table05">
            ...
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">图片尺寸：</td>
            ...
            <tr>
            	<td nowrap="nowrap" class="tab_td_edit_r" width="1%">视频摘要：</td>
                <td nowrap="nowrap" class="tab_td_edit_l"><input id="N_Content" runat="server" type="text" class="page03_1"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td nowrap="nowrap" class="tab_td_edit_l" ><span style="color:Red;">图片宽度：495像素，图片高度：190像素；图片宽度：245像素，图片高度：190像素。</span></td>
            </tr>
            <tr>
                <td nowrap="nowrap" class="tab_td_edit_t" colspan="2"><asp:Image ID="N_Img" runat="server" ImageUrl="~/images/dl_i1.gif" height="190"/></td>
            </tr>
        </table>
    </form>
</body>
