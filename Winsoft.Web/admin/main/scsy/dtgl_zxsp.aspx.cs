...
{
    public partial class dtgl_zxsp : System.Web.UI.Page
    {
        ...
        protected void rtManager_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                bool result = true;//NewsInfoManage.GetInstance().Delete(id);
        ...
        public string DeleteAll(string code)
        {
            ...
            if (codes.Length > 0)
            {
                ...
                {
                    result = true;//NewsInfoManage.GetInstance().Delete(codes[i]);
                }
                switch (result)
                {
                    case true:
