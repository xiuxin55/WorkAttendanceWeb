...
namespace Winsoft.Web.admin.ImageCode
{
    public partial class Image : System.Web.UI.Page
    {
        ...
        private string GenCode(int num)
        {
            ...
            string[] source = { "2", "3", "4", "5", "6", "7", "8", "9", "A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "M", "N", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z" };
            string code = "";
        ...
        private void CreateCheckCodeImage(string checkCode)
        {
            if (checkCode.Trim() == "" || checkCode == null)
                return;
            Session["Code"] = checkCode; //将字符串保存到Session中，以便需要时进行验证 (21.5为汉字长度,15为字母数字的长度)
            ...
            try
            {
                ...
                Font font = new System.Drawing.Font("Arial", 12, (System.Drawing.FontStyle.Bold));//Arial
                System.Drawing.Drawing2D.LinearGradientBrush brush = new System.Drawing.Drawing2D.LinearGradientBrush(new Rectangle(0, 0, image.Width, image.Height), Color.Black, Color.DarkGreen, 1.2F, true);
